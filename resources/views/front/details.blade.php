...
<body class="font-[Poppins]">
	...
	<section id="Article-container" class="max-w-[1130px] mx-auto flex gap-20 mt-[50px]">
		<article id="Content-wrapper" class="leading-relaxed text-justify whitespace-pre-line">
            {!! $post->isi !!}
        </article>
		<div class="side-bar flex flex-col w-[300px] shrink-0 gap-10">
			<div class="flex flex-col w-full gap-3 ads">
				<a href="{{ ($square_advertisments)->link }}">
                    <img src="{{ ($square_advertisments)->thumbnail ? Storage::url($square_advertisments->thumbnail) : '#' }}" class="object-contain w-full h-full" alt="ads" />
                </a>
				<p class="font-medium text-sm leading-[21px] text-[#A3A6AE] flex gap-1">
					Our Advertisments <a href="#" class="w-[18px] h-[18px]"><img
	...
	<section id="Advertisments" class="max-w-[1130px] mx-auto flex justify-center mt-[70px]">
	...
	<section id="Up-to-date" class="w-full flex right mt-[70px] py-[50px] bg-[#F9F9FC]">
		<div class="max-w-[1130px] mx-auto flex flex-col gap-[20px]">
